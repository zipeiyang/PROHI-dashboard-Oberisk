...
if st.button("Calculate risk", help="Input your data to predict the risk", type="primary", use_container_width=True):
    st.switch_page("pages/3_🎯_Obesity Risk Calculator.py")